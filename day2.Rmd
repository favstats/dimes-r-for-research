...
<a href="https://favstats.github.io/dimes-r-for-research/day2">
...
| Time | | Topic |
|------|---|-------|
| **10:15 - 11:00** | | Introduction & The Grammar of Dashboards |
| **11:00 - 11:30** | | Layer 1: Content Collections |
| | | |
| **11:30 - 11:45** | | *Short Break* ☕ |
| | | |
| **11:45 - 12:00** | | **Exercise 1:** Build Your First Content |
| | | |
| **12:00 - 13:00** | | *Lunch Break* 🍕 |
| | | |
| **13:00 - 13:30** | | Layer 2: Pages |
| **13:30 - 13:45** | | **Exercise 2:** Create Pages |
| | | |
| **13:45 - 14:00** | | *Short Break* ☕ |
| | | |
| **14:00 - 14:30** | | Layer 3: Dashboards |
| **14:30 - 15:00** | | **Exercise 3:** Build Complete Dashboard |
| **15:00 - 15:30** | | Tips, Tricks & Function Overview |
| **15:30 - 16:00** | | Q&A + Free Practice |
...
🤓 Akshually, it is accessible in our papers
...
🤓 Akshually, it is on osf/figshare
...
+ Easy to make with limited computational knowledge ❌
...
# And now you can do this YOURSELF thanks to…
...
my_dashboard <- create_dashboard(
  title = "GSS Explorer", output_dir = "gss_dashboard", theme = "flatly"
) %>%
...
.pull-left[
- ✅ A **landing page** with welcome text
- ✅ An **analysis page** with interactive charts
- ✅ An **about page** with attribution
]

.pull-right[
- ✅ A **themed**, **responsive** dashboard
...
```
-- Content Collection ──────────────────────────────────────────────────────────
2 items | ✔ data: 3139 rows x 7 cols

• [Viz] Education Level (bar) x=degree
• [Viz] By Race (bar) x=race
```
...
- Tab "Demographics" → Education chart
- Tab "Attitudes" → Happiness chart
...
```
-- Content Collection ──────────────────────────────────────────────────────────
3 items | ✔ data: 3139 rows x 7 cols

• [Viz] Education (bar) x=degree
• [Viz] Age Distribution (histogram) x=age
• [Viz] Happiness (bar) x=happy
```
...
```
-- Content Collection ──────────────────────────────────────────────────────────
4 items | ✔ data: 3139 rows x 7 cols

ℹ [Text]
• [Viz] Education Level (bar) x=degree
ℹ [Text]
• [Viz] Racial Demographics (bar) x=race
```
...
- 📄 Individual screens in your dashboard
- 🧭 Navigation menu items
- 📦 Containers for content collections
]
...
- ⚙️ **Configuration** — search bars,social links etc.

- 🧭 **Navigation** — how pages are organized

- 📁 **Output** — where files are generated

- 🎨 **Theming** — colors, fonts, overall look
...
`output_dir` — folder where all files will be generated.
...
Content → Pages → Dashboard → Generate!
...
.center[
📖 **Full tutorial:** [favstats.github.io/dashboardr/articles/publishing_dashboards](https://favstats.github.io/dashboardr/articles/publishing_dashboards.html)
]
...
📄 **Download:** [github.com/favstats/dashboardr/blob/main/dev/dashboardr_worksheet.Rmd](https://github.com/favstats/dashboardr/blob/main/dev/dashboardr_worksheet.Rmd)
